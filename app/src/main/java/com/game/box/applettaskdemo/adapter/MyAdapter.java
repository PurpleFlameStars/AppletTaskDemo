package com.game.box.applettaskdemo.adapter;
...
import com.game.box.applettaskdemo.R;
...
public class MyAdapter extends BaseAdapter {
   Context context;
   List<DataListBean> data;    //数据源
   private IsClickListener clickListener;
   public void setList(List<DataListBean> data, Context context) {
      this.data = data;
   ...
   public View getView(int position, View convertView, ViewGroup parent) {
      ...
      final DataListBean adData=data.get(position);
      if (convertView==null) {
   ...
   public interface IsClickListener{
      void click(DataListBean adData);
   }
