package com.game.box.applettaskdemo.view;
...
public class LoadingView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.game.box.ydlibrary.R.styleable.LoadingView);
            mFrameCount = a.getInt(com.game.box.ydlibrary.R.styleable.LoadingView_frame_count, mFrameCount);
            mFrameInterval = a.getInt(com.game.box.ydlibrary.R.styleable.LoadingView_frame_interval, mFrameInterval);
            a.recycle();
        }
